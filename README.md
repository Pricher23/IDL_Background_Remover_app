...
The main training dataset is hosted separately on Kaggle. Download it from the Kaggle link used for the project and place it in the correct dataset folder before training.
